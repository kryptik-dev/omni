...
export const LiveWaveform = ({
            ...
            const animateProcessing = () => {
                ...
                if (mode === "static") {
                    ...
                    for (let i = 0; i < barCount; i++) {
                        ...
                        // Re-apply Volume Reactivity
                        const activeVol = Math.max(0.1, volume * 1.5);
                        const jitter = Math.random() * 0.1 * volume;

                        const combinedWave = (wave1 + wave2 + wave3 + jitter) * activeVol
                        const processingValue = Math.max(0.1, combinedWave * centerWeight)
                    ...
                    for (let i = 0; i < barCount; i++) {
                        ...
                        // Re-apply Volume Reactivity (Scrolling)
                        const activeVol = Math.max(0.1, volume * 1.5);
                        const jitter = Math.random() * 0.1 * volume;
    ...
    }, [processing, active, barWidth, barGap, mode, volume])
